...
public class BaseAmountCalculatorTest {
    ...
    void testCalculateBaseAmount_ReturnsZero_WhenNotEligible() {
        ...
        assertEquals(0F, BaseAmountCalculator.calculate(input.getFamilyComposition(), input.getNumberOfChildren(), input.getFamilyUnitInPayForDecember()));
    }
    ...
    void testCalculateBaseAmount_Returns120_WhenMarriedWithoutChildren() {
        ...
        assertEquals(120F, BaseAmountCalculator.calculate(input.getFamilyComposition(), input.getNumberOfChildren(), input.getFamilyUnitInPayForDecember()));
    ...
    void testCalculateBaseAmount_Returns60_WhenSingleWithoutChildren() {
        ...
        assertEquals(60F, BaseAmountCalculator.calculate(input.getFamilyComposition(), input.getNumberOfChildren(), input.getFamilyUnitInPayForDecember()));
    }
}